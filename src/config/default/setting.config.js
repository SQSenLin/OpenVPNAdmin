...
module.exports = {
  ...
  systemName: 'OpenVPN Admin',         //系统名称
  copyright: '2020 SQSenLin',     //copyright
  ...
  footerLinks: [                        //页面底部链接，{link: '链接地址', name: '名称/显示文字', icon: '图标，支持 ant design vue 图标库'}
    {link: 'https://openvpn.sqsenlin.com', name: 'OpenVPN Admin'},
    {link: 'https://github.com/SQSenLin/OpenVPNAdmin.git', icon: 'github'},
    {link: 'https://www.sqsenlin.com', name: 'SQSenLin'}
  ],
}
